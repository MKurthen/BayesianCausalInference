...
# script to subsample the TCEP benchmark set with 20 samples per dataset. This
...
BENCHMARK_FOLDER = (
    '/afs/mpa/home/maxk/bayesian_causal_inference/benchmarks/tcep_75samples_x20/')
...
for x in range(20):
    ...
    for i in range(108):
        ...
        subsample_indices = np.random.choice(
                np.arange(dataset.shape[0]), min(75, dataset.shape[0]), replace=False)
